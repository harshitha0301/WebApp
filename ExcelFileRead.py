...
ExcelFileRead = Flask(__name__, template_folder=".")
...
if __name__ == "__main__":
    ...
    ExcelFileRead.config['APPINSIGHTS_INSTRUMENTATIONKEY'] = 'b77836d0-17fc-446a-b283-f0d24bf171db'

    # log requests, traces and exceptions to the Application Insights service

    appinsights = AppInsights(ExcelFileRead)
